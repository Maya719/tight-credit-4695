...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tight-credit-4695
```

A live public deployment of this template is available at [https://tight-credit-4695.templates.workers.dev](https://tight-credit-4695.templates.workers.dev)
